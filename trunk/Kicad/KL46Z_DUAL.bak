...
U 1 1 538A82C2
P 2800 4100
F 0 "J10" H 3400 6550 60  0000 C CNN
F 1 "FRDM_KL46Z" H 2800 6550 60  0000 C CNN
...
U 1 1 538B28AD
P 4200 3250
F 0 "#PWR038" H 4200 3250 30  0001 C CNN
...
U 1 1 538B2BB9
P 4200 4350
F 0 "#PWR039" H 4200 4350 30  0001 C CNN
...
U 1 1 538B2BBF
P 4200 4450
F 0 "#PWR040" H 4200 4450 30  0001 C CNN
...
U 1 1 538B2BCA
P 4100 4650
F 0 "#PWR041" H 4100 4610 30  0001 C CNN
F 1 "+3.3V" H 4100 4760 30  0000 C CNN
...
U 1 1 538B2BD7
P 4100 4850
F 0 "#PWR042" H 4100 4810 30  0001 C CNN
...
U 1 1 538B33AD
P 7050 4100
F 0 "J11" H 7650 6550 60  0000 C CNN
F 1 "FRDM_KL46Z" H 7050 6550 60  0000 C CNN
...
U 1 1 538B3414
P 8450 3250
F 0 "#PWR043" H 8450 3250 30  0001 C CNN
...
U 1 1 538B3424
P 8450 4350
F 0 "#PWR044" H 8450 4350 30  0001 C CNN
...
U 1 1 538B342A
P 8450 4450
F 0 "#PWR045" H 8450 4450 30  0001 C CNN
...
U 1 1 538B3431
P 8350 4650
F 0 "#PWR046" H 8350 4610 30  0001 C CNN
...
U 1 1 538B3437
P 8350 4850
F 0 "#PWR047" H 8350 4810 30  0001 C CNN
F 1 "+3.3V" H 8350 4960 30  0000 C CNN
...
U 1 1 538B7689
P 8750 4250
F 0 "#PWR048" H 8750 4220 20  0001 C CNN
F 1 "+8V" H 8750 4360 30  0000 C CNN
...
U 1 1 538B7696
P 4500 4250
F 0 "#PWR049" H 4500 4220 20  0001 C CNN
F 1 "+8V" H 4500 4360 30  0000 C CNN
F 2 "" H 4500 4250 60  0000 C CNN
F 3 "" H 4500 4250 60  0000 C CNN
	1    4500 4250
	1    0    0    -1  
$EndComp
Text HLabel 10450 700  2    60   UnSpc ~ 0
M0_STEP
Text HLabel 10450 800  2    60   UnSpc ~ 0
M1_STEP
Text HLabel 10450 900  2    60   UnSpc ~ 0
M2_STEP
Text HLabel 10450 1000 2    60   UnSpc ~ 0
M3_STEP
Text HLabel 10450 1100 2    60   UnSpc ~ 0
M0_FR
Text HLabel 10450 1200 2    60   UnSpc ~ 0
M1_FR
Text HLabel 10450 1300 2    60   UnSpc ~ 0
M2_FR
Text HLabel 10450 1400 2    60   UnSpc ~ 0
M3_FR
Text HLabel 10450 1600 2    60   UnSpc ~ 0
SCL
Text HLabel 10450 1700 2    60   UnSpc ~ 0
SDATA
...
TPM0_CH3
Text Label 10350 800  2    60   ~ 0
TPM0_CH3
Text Label 10350 700  2    60   ~ 0
TPM0_CH2
Text Label 10350 900  2    60   ~ 0
TPM0_CH4
...
E3
Text HLabel 10450 1800 2    60   UnSpc ~ 0
M_CS
Text HLabel 10450 1900 2    60   UnSpc ~ 0
L_CS
...
SPI0_CS1
Text HLabel 10450 2200 2    60   UnSpc ~ 0
X_RX
Text HLabel 10450 2100 2    60   UnSpc ~ 0
X_TX
Text Label 10350 2100 2    60   ~ 0
UART0_TX
Text Label 10350 2200 2    60   ~ 0
UART0_RX
Text HLabel 10450 2300 2    60   UnSpc ~ 0
X_ON
...
E20
Text HLabel 10450 2700 2    60   UnSpc ~ 0
M_SRCLR_b
Text HLabel 10450 2800 2    60   UnSpc ~ 0
M_OE_b
Text HLabel 10450 3000 2    60   UnSpc ~ 0
L_SRCLR_b
Text HLabel 10450 3100 2    60   UnSpc ~ 0
L_OE_b
