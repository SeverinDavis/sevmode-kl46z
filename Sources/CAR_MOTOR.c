...
void CAR_MOTOR_init()
{
	...
	//direction
	gpio_init_port_init(port_E, pin_0, alt_1, output); 
	gpio_init_port_init(port_E, pin_1, alt_1, output);
	gpio_init_port_init(port_E, pin_2, alt_1, output);
	gpio_init_port_init(port_E, pin_3, alt_1, output);
